...
from main import get_prefix, version
...
class helpCog(commands.Cog):
    ...
    async def help(self, ctx, *input):
        ...
        prefix = get_prefix(None, ctx.guild.id)
     #   version =  # enter version of your code

        # setting owner name - if you don't wanna be mentioned remove line 49-60 and adjust help text (line 88)
        owner = "UFifty50 YT#2567"  # ENTER YOU DISCORD-ID
        ...
        if not input:
            ...
            emb.set_footer(text=f"Jonty is is currently version {version}")
        # It is currently maintained by {owner}\n   \
        ...
        # too many cogs requested - only one at a time allowed
            ...
            emb = discord.Embed(title="It's a magical place.",
                                description="I don't know how you got here. But I didn't see this coming at all.\n"
                                            ...
                                            "https://github.com/UFifty50/Jonty/issues\n"
                                            "Thank you! ~Fifty",
